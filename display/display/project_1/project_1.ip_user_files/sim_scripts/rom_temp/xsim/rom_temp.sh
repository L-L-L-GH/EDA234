...
#
# Script generated by Vivado on Fri Jan 16 13:11:30 +0100 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : rom_temp.sh
...
#
# Usage        : rom_temp.sh
#                rom_temp.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rom_temp.sh [-reset_run]
#                rom_temp.sh [-reset_log]
#                rom_temp.sh [-help]
#
...
# script info
echo -e "rom_temp.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rom_temp.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rom_temp xil_defaultlib.rom_temp xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim rom_temp -key {Behavioral:sim_1:Functional:rom_temp} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rom_temp.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rom_temp.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rom_temp.sh [-help]\n\
Usage: rom_temp.sh [-step]\n\
Usage: rom_temp.sh [-lib_map_path]\n\
Usage: rom_temp.sh [-reset_run]\n\
Usage: rom_temp.sh [-reset_log]\n\
Usage: rom_temp.sh [-keep_index]\n\
Usage: rom_temp.sh [-noclean_files]\n\n\
